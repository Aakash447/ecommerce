...
Route::post('update/product/wp/{id}','Admin\ProductController@UpdateProductWP');
Route::post('update/product/p/{id}','Admin\ProductController@UpdateProductPhoto');
...
Route::get('products/details/{id}/{product_name}','ProductController@ProductView');
Route::post('cart/product/add/{id}','ProductController@AddCart');
// for index page quick view modal
...
// Route::get('/cart/product/view/{id}',function(){
...
Route::get('coupon/remove/','CartController@CouponRemove')->name('coupon.reomve');

// blogpost
Route::get('blog/post/','BlogController@blog')->name('blog.post');
Route::get('lanquage/english','BlogController@English')->name('lanquage.english');
Route::get('lanquage/hindi','BlogController@Hindi')->name('lanquage.hindi');
...
// profile page order view
Route::get('user/order/view/{id}','FrontController@OrderView');
...
Route::get('contact/message/{id}','ContactController@ViewMessage');
