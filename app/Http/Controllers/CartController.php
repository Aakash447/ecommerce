...
class CartController extends Controller
{
    ...
    public function removeCart($rowId){
        Cart::remove($rowId);
        $notification=array(
                        'messege'=>'Item deleted from Cart',
                        'alert-type'=>'success'
                         );
    ...
    public function Checkout(){
        if(Auth::check()){
            ...
            $notification=array(
                        'messege'=>'First Login Your account',
                        'alert-type'=>'success' 
                         );
    ...
    public function Coupon(Request $request){
        ...
        if($check){  
            ...
            echo "Not a right coupon ";
            $notification=array(
                        'messege'=>'Not a coupon',
                        'alert-type'=>'success' 
                         );
            return Redirect()->back()->with($notification);
        }
