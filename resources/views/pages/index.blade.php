 ...
 @php
     ...
     $featured = DB::table('products')->where('status',1)
                ->orderBy('id','desc')->limit(14)->get();

     $trend = DB::table('products')->where('status',1)
            ->where('trend',1)->orderBy('id','desc')->limit(14)->get();

     $best = DB::table('products')->where('status',1)
            ->where('best_rated',1)->orderBy('id','desc')->limit(14)->get();
            ...
            <div class="featured_slider_item">
                ...
                <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                    <div class="product_image d-flex flex-column align-items-center justify-content-center">
                        <a href="{{ url('products/details/'.$row->id.'/'.$row->product_name) }} "><img src="{{ asset( $row->image_one )}}" alt="" style="height: 120px;width: 100px"></a></div>
                    <div class="product_content">
                        ...
                        <div class="product_name"><div><a 
                            href="{{ url('products/details/'.$row->id.'/'.$row->product_name) }} ">{{ $row->product_name }} </a></div></div>
                            <!-- for modal -->
                    ...
                    <div class="product_extras">
                        ...
                        data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)" >Quick View</button>
                        </div>
                    </div>
...
@php
    $mid = DB::table('products')
        ...
        ->where('mid_slider',1)->where('status',1)->orderBy('id','desc')->limit(3)
        ->get();
@endphp
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        <div class="banner_2_category"><h4>{{ $row->category_name }}<h4>
                                         </div>
...
@php 
  ...
  $catid = $cats->id ;
  $products = DB::table('products')->where('category_id',$catid)->where('status',1)
...
$buyget = DB::table('products')
        ->join('brands','products.brand_id','brands.id')
        ->select('products.*','brands.brand_name')
        ->where('status',1)->where('buyone_getone',1)->orderBy('id','desc')
        ->limit(6)->get();
@endphp                
                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            ...
                            <div class="newsletter_text"><p>...and receive updates regarding jewellery
                             trend and get     discount coupon at every shopping.</p></div>
                        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="" id="pimage"  style="height: 220px; width: 200px;margin-left: 20px;margin-top: 15px;">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <ul class="list-group">
                  ...
                  <li class="list-group-item">Stock: <span class="badge" style="background: green;color:white;">
                      Available
                  </span></li>
                </ul>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" style="margin-left: 10px;" name="qty" value="1">
                </div>
...
<!-- Script for modal product quick view -->
