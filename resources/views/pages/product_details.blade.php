...
@endif
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input class="form-control"  value="1" pattern="[0-9]" type="number" name="qty">
										</div>
									</div>

								</div>

								<!-- </div> --> <!-- remove it if problem accours  -->
                ...
                <div class="addthis_inline_share_toolbox_if5l"></div>
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5eb5b68e7f318c66"></script>
