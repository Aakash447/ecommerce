                ...
                <div class="col-lg-5" style="border:1px solid grey;padding:20px;border-radius: 25px;">
                    <div class="contact_form_container">
                        <div class="contact_form_title text-center">Shipping Address</div>
                          ...
                          <?php
                            $total = Session::get('coupon')['balance'] + $charge + $vat ;
                          ?> 
                        <!-- stripe payment page -->
                        <form action="{{ route('stripe.charge') }} " method="post" id="payment-form">
                          ...
                          <button class="btn btn-info btn-sm">Pay Now</button>
                        </form>
...
// Create a Stripe client .  pk_test_yuG4cuR46LtPz11nL4w3zaP300q964B9Zk
var stripe = Stripe('pk_test_yuG4cuR46LtPz11nL4w3zaP300q964B9Zk');
