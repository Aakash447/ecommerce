...
<link rel="stylesheet" type="text/css" href="{{ asset('public/frontend/styles/shop_responsive.css') }} ">
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">Sub Categories Product </h2>
		</div>
	</div>
...
<!-- 						<div class="sidebar_section">
						...
						<div class="sidebar_section">
							...
							<ul class="brands_list">
								...
								@endphp
								<li class="brand"><a href="{{ url('brands/'.$brand->id) }}">{{ $brand->brand_name }} </a></li>
								@endforeach
							</ul>
						</div>
					</div>
					...
					<div class="shop_content">
						...
						<div class="product_grid row">
							...
							<div class="product_item is_new">
								...
								<div class="product_image d-flex flex-column align-items-center justify-content-center"><a href="{{ url('products/details/'.$pro->id.'/'.$pro->product_name) }}"><img src="{{ asset($pro->image_one) }}" style="height:100px;width:100px;" alt=""></a></div>
								<div class="product_content">
									
									@if($pro->discount_price == NULL)
			                            <div class="product_price discount">{{$pro->selling_price }} </div>
			                        @else
			                            <div class="product_price discount">{{$pro->discount_price }} <span>{{$pro->selling_price }} </span></div>
			                        @endif

									<div class="product_name"><div><a 
										href="{{ url('products/details/'.$pro->id.'/'.$pro->product_name) }}"
										 tabindex="0">{{ $pro->product_name }} </a></div></div>
								</div>
