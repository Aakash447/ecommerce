        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Google Analytic : <span class="tx-danger">*</span></label>
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  <label class="form-control-label">Bing Analytic : <span class="tx-danger">*</span></label>
