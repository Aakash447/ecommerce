    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <form method="post" action="{{ url('update/product/wp/'.$product->id) }}  " enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Quanitity: <span class="tx-danger">*</span></label>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" value=" {{ $product->selling_price }}" name="selling_price" >
                </div>
              </div><!-- col-4 -->
       ...
       <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Update Images  </h6>
           ...
           <form method="post" action="{{ url('update/product/p/'.$product->id)  }}  " enctype="multipart/form-data">
            @csrf
            <div class="row" > 
