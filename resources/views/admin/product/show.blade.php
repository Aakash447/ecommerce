        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Quanitity: <span class="tx-danger">*</span></label><br>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Image One (Main): <span class="tx-danger">*</span></label> <br>
