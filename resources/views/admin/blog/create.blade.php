            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Post Title (Eng): <span class="tx-danger">*</span></label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="post_title_in"  placeholder="Enter Post Title">
                </div>
              </div><!-- col-4 -->
